...
ERRORS = {
    ...
    "DL003": ("Douyin chặn tải trực tiếp", "Douyin yêu cầu phiên trình duyệt nhưng chế độ an toàn không đọc cookie Chrome hoặc Edge.", "Hãy tải video mà bạn có quyền sử dụng về máy, sau đó bấm CHỌN VIDEO. Không cần đóng trình duyệt hoặc tắt tiến trình Windows."),
